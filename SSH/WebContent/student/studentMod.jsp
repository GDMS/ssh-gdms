									...
									<tr valign="top">
										...
										<td>
											<table>
												...
												<tr>
													<td id="box">
														<s:form theme="simple" action="studentMod"
																...
																<tr>
																	...
																	<td id="sex">
																		<s:radio theme="simple" cssClass="radio"
																			...
																			value="%{student.gender}" disabled="true" />
																		<br>
																	</td>
																</tr>
																<tr>
																	...
																	<td style="padding-top: 7px">
																		<s:doubleselect name="majorno" list="major"
																			...
																			doubleCssClass="select2" disabled="true" />
																	</td>
																</tr>
																<tr>
																	<td class="textfield_label">
																	...
																	<td>
																		<s:textfield theme="simple" id="credit"
																			...
																			size="6" cssClass="textfield" readonly="true" />
																		<br>
																	</td>
																</tr>
																<tr>

...
<html>
	...
	<body>
		...
		<table width="841" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="378" height="35" valign="top">
					<FONT SIZE="+1" COLOR="#ff6600">删除学生的课题分配结果页面</FONT>
				</td>
			...
			<tr>
				<td height="405" valign="top">
					...
					<s:form action="subAssignedDel" method="post" namespace="/admin">
						<table align="center">
							...
							<tr valign="baseline">
								...
								<td>
									<s:textfield name="student.studentno" size="32" value="%{student.studentno}" readonly="true" />
								</td>
							</tr>
							<tr valign="baseline">
								<td class="tableTop" nowrap align="right" width=100>
		...
		<center>
			<A HREF="admin/subAssignedInfo.action">返回</A>
		</center>

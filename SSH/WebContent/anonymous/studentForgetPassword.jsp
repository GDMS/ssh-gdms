		...
		<tr valign="top">
							...
							<table width="auto">
								<tr valign="top">
									...
									<td>
										<table>
											<tr valign="top">
												<td id="info"><s:actionmessage /> <s:actionerror />
													请输入你的信息：</td>
											</tr>
											<tr>
												<td id="box"><s:form theme="simple"
														action="studentForgetPassword" namespace="/anonymous"
														method="post">
														<table border="0px">
															<tr valign="top">
																<td class="textfield_label">学号：</td>
																<td id="name"><s:textfield theme="simple"
																		cssClass="textfield" name="studentno" size="20" /> <br>
																</td>
															</tr>
															<tr valign="top">
																<td class="textfield_label">姓名：</td>
																<td id="name"><s:textfield theme="simple"
																		cssClass="textfield" name="name" size="20" /> <br>
																</td>
															</tr>
															<tr valign="baseline">
			...
			<td id="cue" align="right">
				<table style="padding-top: 10px">
					...
					<tr bgcolor="#dcdcdc">
						<td class="tableInfo">请从您的注册邮箱中获取您的密码。

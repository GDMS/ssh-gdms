					...
					<div id="thirdcol">
						<div id="mainmenu">
							<ul>
								...
								<li>
									<a href="teacher/preview.action">查看学生预选情况并选择分配</a>
								</li>
								<li>
									<a href="teacher/subReassign.action">为您指导的学生重新分配课题</a>
								</li>
								<li>
									<a href="teacher/subnameMod.action">为您指导的学生更改课题名称</a>
								</li>
								<li>
								...
								<li>
									<a href="teacher/gradeInput!query.action">
										选择学生并输入该学生的论文成绩和评语 </a>
								</li>
								<li>

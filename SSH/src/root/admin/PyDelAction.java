...
public class PyDelAction extends ActionSupport {
	 ...
	 * Log
	 */
	private static final Log log = LogFactory.getLog(PyDelAction.class);
	/**
	 * Sping依赖注入的DAO类.
	 */
	@Autowired
	...
	public String execute() throws Exception {
		...
		if(py!=null){
			log.info("删除评语："+ReflectionToStringBuilder.toString(py));
			pyDAO.delete(py);
		}

...
<html>
	...
	<body>
		...
		<TABLE CELLSPACING="2" CELLPADDING="5" BORDER="0">
			...
			<s:iterator value="students" var="student" status="st2">
				<tr class="tableDetail">
					...
					<td align="center" class="tableDetail">
						<s:property value="studentScore.grade" />
					</td>
					<td align="center" class="tableDetail">
						<A HREF="admin/printManage!view.action?studentNo=${student.studentno}">查看</A>
					</td>
					<td align="center" class="tableDetail">
		...
		<div>
			...
			<a id="pre"
				href="admin/printManage!adminuse.action?page=${page-1}">上一页</a>
			，
			<a id="next"
				href="admin/printManage!adminuse.action?page=${page+1}">下一页</a>
			转到：第

...
public class TeacherDAO extends HibernateDaoSupport {
	...
	public static final String MAXASSIGN = "maxassign";
	...
	public List findByMaxassign(Object maxassign) {
		return findByProperty(MAXASSIGN, maxassign);
	}

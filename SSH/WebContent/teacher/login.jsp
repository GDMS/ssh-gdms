...
<html>
	<head>
		...
		<script type="text/javascript" src="teacher/login.js"></script>
	...
	<body>
		...
		<table id="login" align="center" width="780px" height="400"
			...
			<tr>
				<td>
					<s:form action="teacherLogin" namespace="/teacher">
						<table id="teacher" class="box" style="border: 0px solid #000;">
							<tr>
								<td>
									<table>
										<tr style="border: 2px">
											...
											<td class=user_main_input>
												<s:textfield theme="simple" id="name"
													cssClass="TxtUserNameCssClass" name="teacher.name" />
											</td>
										</tr>
										<tr>
											<td class=user_main_text>
											...
											<td class=user_main_input>
												<s:password theme="simple" id="password"
													cssClass="TxtPassWordCssClass" name="teacher.password" />
											</td>
										</tr>
									</table>
									<table>
										<tr>
											<td class=pw_forget>
												<a href="anonymous/teacherForgetPassword.jsp">忘记密码?</a>
											</td>
										</tr>
									</table>
								</td>

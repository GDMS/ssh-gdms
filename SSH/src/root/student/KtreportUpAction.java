...
public class KtreportUpAction extends ActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7109413235332780500L;
	/**
	 * Log
	 */
	...
	public String execute() throws Exception {
		...
		String fullname = "KTReport" + fname + "." + typeName;
		OutputStream out = new FileOutputStream(new File(path + "\\"
				+ "KTReport" + fname + "." + typeName));
		...
		out.flush();
		out.close();
		student.getStudentMaterialUpload().setKtup(fullname);
		log.info("开题报告上传到服务器："+fullname);
		return SUCCESS;
	}

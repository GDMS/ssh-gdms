...
<html>
	<head>
		...
		<script type="text/javascript"
			src="_decorators/jquery-ui-1.8.16.min.js"></script>
			...
			<div id="menu-wrap">
				<div id="menu">
					<ul>
						...
						<li>
							<a id="studentLogin" href="student/login.jsp" accesskey="2"
								title="">学生登录</a>
						</li>
						<li>
							<a id="teacherLogin" href="teacher/login.jsp" accesskey="3"
								title="">教师登录</a>
						</li>
						<li>
							<a id="adminLogin" href="admin/login.jsp" accesskey="4" title="">管理员登录</a>
						</li>
						<li>
		...
		<div id="navigatorWrap" class="outer-west"
			...
			<div id="navigator">
				...
				<div style="width: auto; padding-top: 5px; padding-left: 20px;">
					<ul class="tree">
						<li id="studentMain" style="display: none;">
							...
							<ul>
								...
								<li>
									<a href="student/studentPassword!studentquery.action">
										学生修改密码 </a>
								</li>
								<li>
						...
						<li id="teacherMain" style="display: none;">
							...
							<ul>
								...
								<li>
									<a href="teacher/teacherPassword!teacherquery.action">
										教师修改密码 </a>
								</li>
								<li>
						...
						<li id="adminMain" style="display: none;">
						...
						<li id="studentReg" style="display: none;">

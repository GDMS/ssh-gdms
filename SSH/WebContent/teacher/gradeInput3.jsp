  	...
  	<table width="841" border="0" cellpadding="0" cellspacing="0">
		...
		<tr> 
    		<td height="405" valign="top"><p>请输入你对该论文的成绩和评语：</p>
	        		<table align="center" >
	        		<tr valign="baseline"> 
 				<s:form action="gradeInput!pyinfo.action" method="post" namespace="/teacher" >
          			<tr valign="baseline">
			            <td class="tableHeading" nowrap align="right" valign=top>学号：</td>
			            <td><s:textfield  value="%{student.studentno}" name="student.studentno" rows="3" cols="32" readonly="true"/></td>
			        </tr>
			      
          			<tr valign="baseline">
			            <td class="tableHeading" nowrap align="right" valign=top>指导评语：</td>
			            <td><s:textarea id="projDesc" value="%{Zdpingyu}" name="Zdpingyu" style="WIDTH: 242px; HEIGHT: 86px" rows="3" cols="32"/></td>
			        </tr>
			        <tr valign="baseline">
			            <td class="tableHeading" nowrap align="right" valign=top>评阅评语：</td>
			            <td><s:textarea id="thesDesc" value="%{Pypingyu}" name="Pypingyu" style="WIDTH: 242px; HEIGHT: 86px" rows="3" cols="32"/></td>
			        </tr>
			          
			          <tr valign="baseline">
			            <td class="tableHeading" nowrap align="right" valign=top>答辩评语：</td>
			            <td><s:textarea id="thesDesc" value="%{Dbpingyu}"  name="Dbpingyu"  style="WIDTH: 242px; HEIGHT: 86px" rows="3" cols="32"/></td>
			        </tr>

...
<html>
	<head>
		<title>管理员查看视图-未分配学生名单</title>
		<link rel="stylesheet" type="text/css" href="css/master.css">
	</head>

	<body>
		<script type="text/javascript" src="admin/views5.js"></script>
		...
		<table width="100%">
			<tr>
				<td>
					<font SIZE="+1" COLOR="#ff6600">未分配学生名单：</font>
				</td>

				<td>
							<a href="admin/views5!Excel.action?printable=true">点此导出Excel</a> 
					<br>
					<br>
				</td>
			</tr>
		...
		<div>
			...
			<a id="pre" href="admin/views5!query.action?page=${page-1}">上一页</a> ，
			<a id="next" href="admin/views5!query.action?page=${page+1}">下一页</a>
			转到：第

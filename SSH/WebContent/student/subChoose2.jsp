...
<html>
	...
	<body>
		...
		<table align="center" width="740px" border="0px">
			...
			<tr>
				<td colspan="2">
					<s:form name="subChoose" namespace="/student" method="post">
						<div>
							<font size="2">志愿顺序：</font>
							<s:select theme="simple" list="{1,2,3}" name="order"></s:select>
						</div>
						<input type=text name="thesisno" value="${thesisno}"

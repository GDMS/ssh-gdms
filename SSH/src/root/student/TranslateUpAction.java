...
public class TranslateUpAction extends ActionSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9038538522896507672L;
	...
	public String execute() throws Exception {
		...
		String fullname = "translate" + fname + "." + typeName;
		OutputStream out = new FileOutputStream(new File(path + "\\"
				+ "translate" + fname + "." + typeName));
		...
		out.flush();
		out.close();
		student.getStudentMaterialUpload().setTransup(fullname);
		log.info("翻译资料上传到服务器："+fullname);
		return SUCCESS;
	}

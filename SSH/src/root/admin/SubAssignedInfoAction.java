...
public class SubAssignedInfoAction extends ActionSupport {
	 ...
	 * Log
	 */
	private static final Log log = LogFactory.getLog(SubAssignedInfoAction.class);
	...
	public String execute() throws Exception {
		...
		students = studentDAO.findByThesisNotNull();
		if (page == 0)
			page = 1;

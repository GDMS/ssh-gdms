...
/**
 * Views2Id entity. @author MyEclipse Persistence Tools
 */

public class Views2Id implements java.io.Serializable {
	...
	/** full constructor */
	public Views2Id(String sid, Integer suborder) {
		this.sid = sid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Views2Id))
			return false;
		Views2Id castOther = (Views2Id) other;

		...
		<table width="941" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="378" height="35" valign="top">
					<FONT SIZE="+1" COLOR="#ff6600">教师查看管理员通知页面</FONT>
				</td>
				<td width="300"></td>
			...
			<tr>
				<td height="405" valign="top">
					<p></p>
					<table width="463" border="0" cellspacing="2" cellpadding="4"
						style="WIDTH: 463px;">
						<tr class="tableHeading">
							<td width="150">
								<B><FONT COLOR="white">请留意：</FONT> </B>
							</td>
						</tr>
						<tr bgcolor="#dcdcdc">
							<td>
							...
							<td>
								<b><font color=slategray>各位指导老师：</font> </b>
								<br>
								&nbsp;&nbsp;&nbsp;
								<textarea style="WIDTH: 282px; HEIGHT: 86px" rows=3 cols=32
									readonly="readonly">msgToTea</textarea>
							</td>
						</tr>
					</table>
				</td>
